...
percent_combos = list(itertools.combinations(percentages, 2))

# randomize order of trials
random.shuffle(percent_combos)
...
for src, src_title in trials:    
    for left_percent, right_percent in percent_combos:
